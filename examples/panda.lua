...
pdf.hooks.on_monthly_page(function(page)
    ...
    page.push(cell_rect_text({ row = 26, col = 1, width = 3, height = 4 }, {
        rect = { mode = "stroke", outline_color = pdf.page.fill_color },
    }))
    page.push(cell_rect_text({ row = 26, col = 5, width = 3, height = 4 }, {
        rect = { mode = "stroke", outline_color = pdf.page.fill_color },
    }))
    ...
    page.push(cell_rect_text({ row = 32, col = 1, width = 3, height = 4 }, {
        rect = { mode = "stroke", outline_color = pdf.page.fill_color },
    }))
    page.push(cell_rect_text({ row = 32, col = 5, width = 3, height = 4 }, {
        rect = { mode = "stroke", outline_color = pdf.page.fill_color },
    }))
end)
