...
---@class (exact) panda.daily-circles.Days
...
---@param opts {bounds:pdf.common.Bounds, days: panda.daily-circles.Days, padding?:pdf.common.PaddingLike}
---@return pdf.object.Group
...
planner:for_monthly_page(function(page, date)
    print("POPULATING MONTHLY PAGE", date:format("%B %Y"))
...
planner:for_weekly_page(function(page, date)
    ...
    print("POPULATING WEEKLY PAGE", week_str .. date:format(" %Y"))
...
planner:for_daily_page(function(page, date)
    print("POPULATING DAILY PAGE", date:format("%B %d, %Y (%a)"))
